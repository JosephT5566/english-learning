...
Persistence-foundation work has started with an application-scoped SQLAlchemy session factory and an
explicit short-lived transaction boundary. No domain schema or migration exists yet.
